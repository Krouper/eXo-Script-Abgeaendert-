...
function HUDUI:drawExo()
	...
	dxDrawText (convertNumber(self:getLocalTarget():getMoney()),screenWidth-width*0.7-r_os,width*0.260,width,height, tocolor ( 255, 255, 255, 255 ), 1.2*width*0.0039, "default-bold" ) --Money
	dxDrawText (time,screenWidth-width*0.22-r_os,width*0.260,width,height, tocolor ( 255, 255, 255, 255 ), 1.2*width*0.0039, "default-bold" ) -- Clock
	--dxDrawText (localPlayer:getPoints().." Punkte",screenWidth-width*0.35-r_os,width*0.372,width,height, tocolor ( 255, 255, 255, 255 ), 1.02*width*0.0039, "default-bold" ) -- ORT
	...
	dxDrawImageSection(bar_x, height*(122.5/imageHeight),bar_width*b_x,bar_height,scroll_,0,207*b_x,15,'files/images/HUD/exo/blue_b.png',0,0,0,tocolor(255,255,255,200)) -- erster Balken

	b_x = self:getLocalTarget():getHealth()/100
	if b_x > (15*0.01) then
		dxDrawImageSection(bar_x ,height*(154.5/imageHeight),bar_width*b_x,bar_height,scroll_,0,207*b_x,15,'files/images/HUD/exo/red_b.png',0,0,0,tocolor(255,255,255,200))
	elseif b_x <= (15*0.01) and ( getTickCount() % 1000 > 500 ) then
		dxDrawImageSection(bar_x ,height*(154.5/imageHeight),bar_width*b_x,bar_height,scroll_,0,207*b_x,15,'files/images/HUD/exo/red_b.png',0,0,0,tocolor(255,255,255,200)) -- zweiter Balken
	end

	b_x = (getPedOxygenLevel(localPlayer))/(1000 + getPedStat(localPlayer, 22)*1.5 + getPedStat(localPlayer, 225)*1.5)
	dxDrawImageSection(bar_x ,height*(186.5/imageHeight),bar_width*b_x,bar_height,scroll_,0,207*b_x,15,'files/images/HUD/exo/cyan_b.png',0,0,0,tocolor(255,255,255,200))
	...
	dxDrawText ("SCHUTZWESTE: "..math.floor(getPedArmor(self:getLocalTarget())).."%",screenWidth-width*0.5-r_os,width*0.375,screenWidth-10,height, tocolor ( r,g,b,a ), 0.8*width*0.0039, "sans","center" ) --Money
	dxDrawText ("LEBEN: "..lebensanzeige.."%",screenWidth-width*0.5-r_os,width*0.475,screenWidth-10,height, tocolor ( r,g,b,a ), 0.8*width*0.0039, "sans","center" ) --Money
	dxDrawText ("ATEMLUFT: "..math.floor((getPedOxygenLevel(localPlayer)*100)/(1000 + getPedStat(localPlayer, 22)*1.5 + getPedStat(localPlayer, 225)*1.5)).."%",screenWidth-width*0.5-r_os,width*0.575,screenWidth-10,height, tocolor ( r,g,b,a ), 0.8*width*0.0039, "sans","center" ) --Money
	...
	dxDrawText(math.floor(self:getLocalTarget():getPlayTime()/60).." Std.",hudStartX+width*0.5, height*0.67,width*0.5, height*0.08, tocolor ( 255,255,255,255 ), 0.9*width*0.0039, "sans","left","top" ) --Money

	dxDrawText(self:getLocalTarget():getWanteds() or 0,hudStartX+width*0.89, height*0.67,width*0.5, height*0.08, tocolor ( 255,255,255,255 ), 0.9*width*0.0039, "sans","left","top" ) --Money
	
	dxDrawText (localPlayer:getPoints().." Punkte",hudStartX+width*0.6, height*0.77,width*0.5, height*0.08, tocolor ( 255,255,255,255 ), 0.9*width*0.0039, "sans","left","top" ) -- ORT
