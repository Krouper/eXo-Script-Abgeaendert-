...
function VehicleSpawnGUI:constructor(spawnerId, vehicleList, showEPTAdvertisement, marker)
	...
	if showEPTAdvertisement then
		...
		GUILabel:new(5, self.m_Height - 85 + 25, self.m_Width - 10, 23, "Sicher, schnell und günstig in LS unterwegs; Rufe gleich das GRS Public Transport (GPT) an!", self.m_Window)
