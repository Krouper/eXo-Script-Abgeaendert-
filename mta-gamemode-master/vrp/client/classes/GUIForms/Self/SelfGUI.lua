...
function SelfGUI:onSettingChange(setting)
	...
	elseif setting == "Texturen" then
		...
		self.m_TextureFileCheck = GUICheckbox:new(self.m_Width*0.02, self.m_Height*0.76, self.m_Width*0.5, self.m_Height*0.04, _"GRS Texturen aktivieren", self.m_SettingBG)
