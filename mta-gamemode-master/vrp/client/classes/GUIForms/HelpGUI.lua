...
HelpGUI.LexiconBaseUrl = "https://grs-reallife.de/"
...
function HelpGUI:constructor()
	...
	self.m_WebView = GUIGridWebView:new(1, 1, 27, 15, ("https://grs-reallife.de/"):format(localPlayer:getSessionId()), true, self.m_Window)
...
function HelpGUI:onBrowserReady(url)
	...
	if type(url) == "string" and not url:find("grs%-reallife%.de") then
