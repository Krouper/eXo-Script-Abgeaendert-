...
function AppBank:onOpen(form)
	...
	GUILabel:new(10, 10, 240, 50, _"GRS-Bank", self.m_Tabs["Info"])
	...
	GUILabel:new(10, 10, 240, 50, _"GRS-Bank", self.m_Tabs["Transfer"])
	...
	donate["GRS Event-Team"] = GUIButton:new(135, 350, 117, 30, _"GRS Event-Team", self.m_Tabs["Transfer"]):setBackgroundColor(Color.Green):setFontSize(.9)
