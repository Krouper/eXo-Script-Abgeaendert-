...
WeaponTruck.spawnPos = {
	...
	["state"] = {2783.69, -2456.28, 14.19, 90}
}
WeaponTruck.loadMarkerPos = {
	["evil"] = Vector3(-1873.56, 1434.15, 7.18),
	["state"] = Vector3(2788.69, -2456.25, 13.64)
}
...
WeaponTruck.boxSpawnCords = {
	...
	["state"] = {
		Vector3(2790.53, -2463.69, 12.7), Vector3(2790.53, -2463.69, 13.4),
		Vector3(2789.79, -2465.73, 12.7), Vector3(2789.79, -2465.73, 13.4),
		Vector3(2788.10, -2466.56, 12.7), Vector3(2788.10, -2466.56, 13.4),
		Vector3(2785.90, -2465.33, 12.7), Vector3(2785.90, -2465.33, 13.4)
				}
}
