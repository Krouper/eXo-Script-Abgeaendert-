...
Tour.Data = {
	{
		...
		["Description"] = "Ich führe dich ein wenig durch GRS-Reallife. Halte dich an meine Tipps und ein super Start ist dir sicher. Gelegentlich wartet auch eine Belohnung für eine Aufgabe auf dich! Folge dem Pfeil über deinem Kopf zur ersten Station!",
	...
	},
	{
		...
		["Success"] = "Es gibt auf GRS-Reallife einige Multiplayer-Minigames. Klicke auf einen Spieler um diese zu starten.",
		["Position"] = Vector3(1463.51, -1169.74, 23.3),
		["Money"] = 250
	},
	{
		["Title"] = "Formel 1 - Naja fast",
		["Description"] = "Der letzte Punkt unserer Tour führt zu einem richtigen Highlight. Der GRS-Reallife Kartbahn!",
