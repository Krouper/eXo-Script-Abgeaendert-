...
function HorseRace:message()
	self:sendShortmessageToPlayers("Um 20:00 findet das tägliche GRS-Pferderennen statt, du kannst im Wettbüro auf ein Pferd setzen und um 20:00 die Live-Übertragung anschauen! Viel Glück!")
end
